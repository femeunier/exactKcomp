...
% RootSys = [WD,'/in/_ROOT_STRUCTURES/flat_2_5m_xy'];     % Very big root system
...
f(1) = figure (1);
draw_root(RootSys,1)
saveas(f(1),[WD,'/figures/RootSystem.png'])
...
saveas(f(2),[WD,'/figures/CondRoot.png'])
...
saveas(f(3),[WD,'/figures/SUFcomp.png'])
...
xlabel('log10K_{comp}')
saveas(f(4),[WD,'/figures/Kcomp.png'])
...
saveas(f(5),[WD,'/figures/Sinkcomp.png'])
...
saveas(f(7),[WD,'/figures/UpscaledSink.png'])
...
saveas(f(8),[WD,'/figures/Sinkdepths.png'])
...
saveas(f(10),[WD,'/figures/fitsk.png'])
close all